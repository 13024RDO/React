    ...
    <ul className="lista-tareas">
       {
        tareas.length > 0 ? tareas.map((tarea)=>{
           ...
           if(verCompletadas){
             return <Tareas key={tareas.id} tarea={tarea} tareaCompletada={tareaCompletada} editaTarea={editaTarea} eliminarTarea={eliminarTarea}/>
